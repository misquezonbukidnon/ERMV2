...
namespace App\Http\Livewire\Global\Modal\ModalDashboard;
...
class DashboardShowemployee extends Component
{
    ...
    {
        return view('livewire.global.modal.modal-dashboard.dashboard-showemployee');
    }
}
