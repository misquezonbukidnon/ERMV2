...
class RecordAddemployeeform extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.page.record.record-addemployeeform', compact('offices', 'positions', 'classifications', 'employmentstatuses'));
    }
}
