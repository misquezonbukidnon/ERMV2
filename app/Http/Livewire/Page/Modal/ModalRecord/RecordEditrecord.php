...
namespace App\Http\Livewire\Page\Modal\ModalRecord;
...
class RecordEditrecord extends Component
{
    use WithFileUploads;
    // Global Input
    public $empId;
    ...
    public function render()
    {
        ...
        return view('livewire.page.modal.modal-record.record-editrecord', compact('offices', 'positions', 'classifications', 'employment_statuses'));
    }
}
