...
<html>
  ...
  <head>
    ...
    <script src="{{ asset('assets/vendor/pharaonic/livewire-select2/public/pharaonic.select2.min.js') }}"></script>
  </head>
      ...
      $(document).on('ready', function() {
        ...
        var datatable = $.HSCore.components.HSDatatables.init($('#columnSearchDatatable', {
          ...
          columns: [{
            ...
            {
              data: 'employment_statuses.name',
              name: 'employment_statuses.name'
            },
          ]
        }));
