    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Import Records</a></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-lg-3">
                ...
                <ul class="list-group mt-5">
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center gx-2">
                            ...
                            <div class="col">
                                <h5 class="mb-0">
                                    <a class="text-dark" href="#">All Classification - Records</a>
                                </h5>
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center gx-2">
                            ...
                            <div class="col">
                                <h5 class="mb-0">
                                    <a class="text-dark" href="#">Regular - Records</a>
                                </h5>
                                <ul class="list-inline list-separator small">
                       ...
                       "type": "css-animation"
                                    ...
                                    <div id="filesListDropdown10" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right" style="min-width: 13rem;">
                                        <span class="dropdown-header">Settings</span>
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center gx-2">
                            ...
                            <div class="col">
                                <h5 class="mb-0">
                                    <a class="text-dark" href="#">Casual - Records</a>
                                </h5>
                                <ul class="list-inline list-separator small">
                       ...
                       "type": "css-animation"
                                    ...
                                    <div id="filesListDropdown11" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right" style="min-width: 13rem;">
                                        <span class="dropdown-header">Settings</span>
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center gx-2">
                            ...
                            <div class="col">
                                <h5 class="mb-0">
                                    <a class="text-dark" href="#">Job Order - Records</a>
                                </h5>
                                <ul class="list-inline list-separator small">
