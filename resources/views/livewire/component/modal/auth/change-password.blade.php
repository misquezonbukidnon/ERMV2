<div class="modal fade" id="changepassmodal" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="js-validate">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="password" class="js-toggle-password form-control" id="showPasswordLabel"
                                placeholder="Enter password" value="" data-hs-toggle-password-options='{
             ...
             "classChangeTarget": "#changePasswordShowIcon"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="password" class="js-toggle-password form-control" id="showPasswordLabel2"
                                placeholder="Confirm password" value="" data-hs-toggle-password-options='{
             "target": ".js-password-toggle-show-target",
             "show": true,
             "defaultClass": "tio-hidden",
             "showClass": "tio-visible",
