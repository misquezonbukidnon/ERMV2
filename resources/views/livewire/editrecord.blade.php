    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">edit Record</a></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-lg-3">
                      ...
                      "targetSelector": "#addUserStepConfirmation"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="input-group input-group-sm-down-break">
                                                                <input type="text" class="form-control" name="firstName" id="firstNameLabel" placeholder="Firstname/Suffix" aria-label="Clarice">
                                                                <input type="text" class="form-control" name="lastName" id="lastNameLabel" placeholder="Middlename" aria-label="Boone">
                                                                <input type="text" class="form-control" name="lastName" id="lastNameLabel" placeholder="Lastname" aria-label="Boone">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Form Group -->
                                    ...
                                    "defaultCreated": 0
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="input-group input-group-sm-down-break align-items-center">
                                                                <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel" placeholder="+xx xxx-xxxx-xx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options='{
                                   "template": "+63 0000000000"
                                                                ...
                                                                <div class="input-group-append">
                                                                    ...
                                                                    <div class="select2-custom">
                                                                        <select class="js-select2-custom" name="phoneSelect" data-hs-select2-options='{
                                 ...
                                 "template": "+0(000)000-00-00"
                                                            ...
                                                            <div class="input-group-append">
                                                                <!-- Select -->
                                                                <div class="select2-custom">
                                                                    <select class="js-select2-custom-dynamic" data-name="additionlPhoneSelect" data-hs-select2-options='{
                                    "minimumResultsForSearch": "Infinity",
                                    "dropdownAutoWidth": true,
                                    "width": "6rem"
                                  }'>
                                                    ...
                                                    <!-- Form Group -->
                                                    <div class="row form-group">
                                                        <label for="organizationLabel" class="col-sm-3 col-form-label input-label">Emergency Contact Person</label>

                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="organization" id="organizationLabel" placeholder="John Doe" aria-label="Htmlstream">
                                                        </div>
                                                    </div>
                                                    <!-- End Form Group -->
                                                    ...
                                                    <!-- Form Group -->
                                                    <div class="row form-group">
                                                        <label for="organizationLabel" class="col-sm-3 col-form-label input-label">Emergency Contact #</label>

                                                        <div class="col-sm-9">
                                                            <input type="number" class="form-control" name="organization" id="organizationLabel" placeholder="+xx xxx-xxxx-xx" aria-label="Htmlstream">
                                                        </div>
                                                    </div>
                                                    <!-- End Form Group -->
                              ...
                              "targetSelector": "#addUserStepBillingAddress"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <!-- Select -->
                                                            <div class="mb-3">
                                                                <select class="js-select2-custom" id="locationLabel" data-hs-select2-options='{
                                    "placeholder": "Select Position"
                                  }'>
                                                                    <option label="empty"></option>
                                                                    <option value="AF" data-option-template='<span class="d-flex align-items-center"><span class="text-truncate">Afghanistan</span></span>'>Programmer</option>
                                                                    <option value="AX" data-option-template='<span class="d-flex align-items-center"><span class="text-truncate">Aland Islands</span></span>'>Tester</option>
                                    ...
                                    "placeholder": "Select Status"
                                                    ...
                                                    <div class="row form-group">
                                                        <label for="locationLabel" class="col-sm-3 col-form-label input-label">Employment Date</label>
                                                        <div class="col-sm-9">
                                                            <!-- Select -->
                                                            <div class="mb-3">
                                                                <!-- Flatpickr -->
                         ...
                         "targetSelector": "#addUserStepBillingAddress"
                                                    ...
                                                    <div class="ml-auto">
                                                        ...
                                                        <button id="addUserFinishBtn" type="button" class="btn btn-primary">update user</button>
                                                    </div>
                                                </div>
                                                <!-- End Footer -->
                                            </div>
