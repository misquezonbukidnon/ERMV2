            ...
            <div class="col-auto">
                ...
                <form>
                    ...
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input wire:model="search" type="search" class="form-control" placeholder="Search Office" aria-label="Search users">
                    </div>
                    <!-- End Search -->
                </form>
                <!-- End Filter -->
            ...
            <table id="officetablelivewire" class="table table-striped  table-lg table-borderless table-thead-bordered table-nowrap table-align-middle">
                    ...
                    <tr>
                        <th>
                            <button wire:click="sortBy('name')" class="btn ml-n3 " style="height: 2.5rem">
                                <p class="font-weight-bold">Office <i class="tio-double-caret-vertical text-primary"></i>
                                </p>
                            </button>
                        </th>
                        <th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button wire:click="officeModalEdit({{ $office->id }})" type="button" class="btn btn-outline-primary btn-xs btn-icon " data-toggle="modal" data-target="#officeEditModal">
                                <i class="tio-edit"></i>
                            </button>
                        </td>
                    </tr>
