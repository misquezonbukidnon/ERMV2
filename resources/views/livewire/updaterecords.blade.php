    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Update Records</a></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-lg-3">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-12 col-md">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="card-header-title">Update Records</h5>
                                </div>
                            </div>
                        ...
                        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="legend-indicator bg-success"></span>Employed
                                        <a class="js-edit btn btn-sm btn-white ml-5" href="javascript:;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="legend-indicator bg-warning"></span>Separated
                                        <a class="js-edit btn btn-sm btn-white ml-5" href="javascript:;">
                                            <i class="js-edit-icon tio-edit"></i> Edit
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="legend-indicator bg-danger"></span>Retired
                                        <a class="js-edit btn btn-sm btn-white ml-5" href="javascript:;">
                                            <i class="js-edit-icon tio-edit"></i> Edit
                                        </a>
                                    </td>
